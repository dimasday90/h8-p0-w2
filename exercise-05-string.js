...
console.log('First Word: ' + firstWord3 + ', with length: ' + firstWord4Length);
console.log('Second Word: ' + secondWord3 + ', with length: ' + secondWord4Length);
console.log('Third Word: ' + thirdWord3 + ', with length: ' + thirdWord4Length);
console.log('Fourth Word: ' + fourthWord3 + ', with length: ' + fourthWord4Length);
console.log('Fifth Word: ' + fifthWord3 + ', with length: ' + fifthWord4Length);